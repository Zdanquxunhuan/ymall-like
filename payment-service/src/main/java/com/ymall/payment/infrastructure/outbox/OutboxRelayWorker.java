...
public class OutboxRelayWorker {
    ...
    public OutboxRelayWorker(OutboxEventMapper outboxEventMapper,
                             ...
                             @Value("${payment.outbox.tag:PaymentEvent}") String fixedTag,
                             @Value("${payment.outbox.max-retries:6}") int maxRetries,
                             @Value("${payment.outbox.retry-base-seconds:2}") int retryBaseSeconds,
                             @Value("${payment.outbox.retry-max-seconds:300}") int retryMaxSeconds) {
