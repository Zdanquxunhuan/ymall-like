...
public class OutboxRelayWorker {
    ...
    public OutboxRelayWorker(OutboxEventMapper outboxEventMapper,
                             ...
                             @Value("${inventory.outbox.tag:StockEvent}") String fixedTag,
                             @Value("${inventory.outbox.max-retries:6}") int maxRetries,
                             @Value("${inventory.outbox.retry-base-seconds:2}") int retryBaseSeconds,
                             @Value("${inventory.outbox.retry-max-seconds:300}") int retryMaxSeconds) {
